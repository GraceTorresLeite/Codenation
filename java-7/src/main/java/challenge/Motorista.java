...
public class Motorista {
    ...
    public Motorista(MotoristaBuilder motoristaBuilder) {
		this.nome = motoristaBuilder.nome;
		this.idade = motoristaBuilder.idade;
		this.pontos = motoristaBuilder.pontos;
		this.habilitacao = motoristaBuilder.habilitacao;
	}
    ...
    public static class MotoristaBuilder {
        ...
        public Motorista build() {
        	Objects.requireNonNull(this.nome, "Nome obrigatório");
        	Objects.requireNonNull(this.habilitacao, "Habilitação obrigatória");
